...
export default function Categories() {
  const categories = trpc.market.categories.useQuery(undefined, { staleTime: 45_000, refetchInterval: 60_000, retry: 1 });
